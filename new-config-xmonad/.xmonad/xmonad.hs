...
myStartupHook  = do
    ...
    spawnOnce "xinput set-prop 'Logitech Wireless Mouse' 'Coordinate Transformation Matrix' 0.2 0 0 0 0.2 0 0 0 1"
    spawnOnce "xinput set-prop 'SynPS/2 Synaptics TouchPad' 'Coordinate Transformation Matrix' 1.5 0 0 0 1.5 0 0 0 1"
    spawnOnce "xinput set-prop 'SynPS/2 Synaptics TouchPad' 'Device Accel Profile' -1"
